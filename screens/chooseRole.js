...
const ChooseRole = ({ navigation }) => {
  ...
  <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => selectedButton === 'button1' ? navigation.navigate('CreateAccountBuyer') : selectedButton === 'button2' ? navigation.navigate('CreateAccountSeller') : Alert.alert('Seleccione tipo de cuenta', 'Debe seleccionar el tipo de cuenta que desea crear', [{ text: 'OK' }])} >
